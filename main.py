...
class MyMainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self, parent=None):
        ...
        self.ui.label_3.setText('<a style="color:black;" href="file:///C:/Users/Etudiant%20FST/Downloads/help%20and%20Information.pdf">Help & Information</a>')
...
############################# Transformations ##############################################
 ...
 ################################ Image Enhancement #################################################################
    ...
    def hist(self):
        ...
        hist_red = cv2.calcHist([self.ui.image], [0], None, [256], [0, 256])
        hist_green = cv2.calcHist([self.ui.image], [1], None, [256], [0, 256])
        hist_blue = cv2.calcHist([self.ui.image], [2], None, [256], [0, 256])

        # Combine histograms into a single array for display
